        ...
        (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div  className="flex flex-col">
              ...
              <button className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mb-20">
                CheckOut Now
              </button>
            </div>
          </div>
